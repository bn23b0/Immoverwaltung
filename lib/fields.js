export const GROUPS = [
  {
    ...
    fields: [
      ...
      { k: 'status', label: 'Status', type: 'select', options: ['im Ankauf', 'im Verkauf', 'in Renovierung', 'Leerstand', 'Vermietet'] },
  ...
  },
  {
    ...
    fields: [
      ...
      { k: 'renovation_costs', label: 'Renovierungskosten (€)', type: 'number', step: '0.01' },
  ...
  },
  {
    ...
    fields: [
      ...
      { k: 'additional_costs', label: 'Nebenkosten-Vorauszahlung Mieter / Monat (€)', type: 'number', step: '0.01', hint: 'Durchlaufender Posten – geht nicht in Cashflow oder Rendite ein.' },
      { k: 'owner_costs', label: 'Nicht umlagefähige Kosten / Monat (€)', type: 'number', step: '0.01', hint: 'Verwaltung, Versicherung, WEG-Anteil – trägst du selbst.' },
    ],
  },
  {
    title: 'Steuer / AfA',
